    ...
    <main>
      ...
      <div  className="Logos">
        <div className="Logo"><a href="/" >
          <img src="http://cine.ar/img/tv.cine.ar.svg" alt="" /></a></div>

        <div className="Logo"><a href="/" >
        <img src="http://cine.ar/img/play.cine.ar.svg" alt=""  /></a></div>

        <div className="Logo"><a href="/">
         <img src="http://cine.ar/img/estrenos.cine.ar.svg" alt="" /></a></div>
